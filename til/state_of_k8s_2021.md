...
### Application Process Must Run as ProcessID (PID) 1
```yaml
- https://tech.trivago.com/2021/06/09/proper-java-application-life-cycle-management-in-kubernetes/
...
- kubectl get order
- acme-test-kuard-2r694-2985458014   pending   21m

- kubectl get challenge
- acme-test-kuard-2r694-2985458014-2430694242   pending   my-test.link   23m
